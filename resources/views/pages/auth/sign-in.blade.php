...
<body class="">
    <div class="container position-sticky z-index-sticky top-0">
        <div class="row">
            <div class="col-12">
                <!-- Navbar -->
                @include('includes.common.mini.mini-navbar')
                <!-- End Navbar -->
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div
                            ...
                            <div class="position-relative h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center"
                                style="background-image: url('../../../assets/img/illus/enter.svg'); background-position: center;background-repeat: no-repeat;background-size: 500px 500px;">
                            </div>
                        </div>
    ...
    <!-- script-src -->
    @include('includes.common.mini.mini-script-src')
    <!-- End script-src -->
