        ...
        <nav
            ...
            <div class="container-fluid ps-2 pe-0">
                <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="/">
                    <img src="../../../assets/img/logo/new/black/logo-only-trans.png"  style="height:30px;width:30px;">
                    Smart Home
                </a>
                                    ...
                                    <ul class="list-group">
                                        <li class="nav-item list-group-item border-0 p-0">
                                            <a class="dropdown-item border-radius-md text-dark"
                                                ...
                                                <span class="text-sm opacity-8 ps-4">All about overview, quick start,
                                        ...
                                        <li class="nav-item list-group-item border-0 p-0">
                                            <a class="dropdown-item border-radius-md text-dark"
                                                ...
                                                <span class="text-sm opacity-8 ps-4">Explore our collection of fully
                                        ...
                                        <li class="nav-item list-group-item border-0 p-0">
                                            <a class="dropdown-item border-radius-md text-dark"
                                                ...
                                                <span class="text-sm opacity-8 ps-4">Check how you can integrate our
                                                    plugins</span>
                                            </a>
                                        </li>
                                        <li class="nav-item list-group-item border-0 p-0">
                                            <a class="dropdown-item border-radius-md text-dark"
                                                ...
                                                <span class="text-sm opacity-8 ps-4">For those who want flexibility,
